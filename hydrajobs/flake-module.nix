...
{  
  flake.hydraJobs = {
    ...
    fmo-os-x86_64-public-debug.x86_64-linux = self.packages.x86_64-linux.fmo-os-x86_64-public-debug;
    fmo-os-x86_64-public-release.x86_64-linux = self.packages.x86_64-linux.fmo-os-x86_64-public-release;
  };
}
