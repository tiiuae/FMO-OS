          ...
          filename: let
            ...
            des =
              ...
              then cfg.file-info.${filename}.des-path
                ...
                (
                  if (builtins.readFileType src-data == "directory")
                  then "${cfg.file-info.${filename}.des-path}"
            ...
            priority =
              if ("${src}" == "" || builtins.readFileType src-data == "directory")
              then 0
              else 1;
          in {
            services.${filename} = {
